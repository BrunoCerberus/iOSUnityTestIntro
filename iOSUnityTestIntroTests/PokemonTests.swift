...
//Imports the application code
@testable import iOSUnityTestIntro
...
class PokemonTests: XCTestCase {
    ...
    /// water Pokemon does more damage against a fire Pokemon than it does against another water Pokemon.
    func testThatAWaterPokemonDoesMoreDamageToAFirePokemon() {
        //1. Have Squirtle Attack Charmander
        squirtle.attack(enemy: charmander) //It was Super Effective!
        
        //2. Now Have Squirtle Attack Psyduck
        squirtle.attack(enemy: psyduck) //Oooh. That had to hurt.
